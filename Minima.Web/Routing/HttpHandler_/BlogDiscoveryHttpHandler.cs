    ...
    public class BlogDiscoveryHttpHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (String.IsNullOrEmpty(HttpContext.Current.Cache[key] as String))
            {
                ...
                xmlWriter.WriteValue(Themelia.Web.HttpWebSection.CurrentWebSectionUrl);
                xmlWriter.WriteEndElement();
                ...
                xmlWriter.WriteAttributeString("apiLink", Themelia.Web.HttpWebSection.CurrentWebSectionUrl + "xml-rpc/");
